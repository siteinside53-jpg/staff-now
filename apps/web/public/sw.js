...
//
// v2 → v3: οι διορθώσεις στην άδεια κάμερας. Οι σελίδες σερβίρονται
// «δίκτυο πρώτα», αλλά σε αργή ή κομμένη σύνδεση επιστρέφει η αποθηκευμένη
// σελίδα — και μαζί της τα ΠΑΛΙΑ αρχεία κώδικα. Σε κινητό αυτό σημαίνει ότι ο
// χρήστης μπορεί να βλέπει ακόμη το παλιό, χαλασμένο μήνυμα άδειας. Ανεβάζοντας
// τον αριθμό, κάθε συσκευή πετάει ό,τι κρατούσε με την πρώτη επίσκεψη.
...
const PRECACHE_URLS = [
  ...
  // Οι ίδιες διευθύνσεις με ?v=3 που ζητάει η σελίδα και το manifest — αλλιώς
