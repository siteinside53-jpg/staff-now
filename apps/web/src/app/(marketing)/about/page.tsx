...
const values = [
  {
    title: 'Ταχύτητα',
    description:
      'Κάθε λεπτό μετράει. Σχεδιάζουμε εργαλεία που μειώνουν τον χρόνο πρόσληψης από εβδομάδες σε ώρες.',
    icon: (
...
const team = [
  {
    ...
    role: 'CEO & Co-founder',
    bio: 'Πρώην στέλεχος στον κλάδο στελέχωσης με 15+ χρόνια εμπειρίας. Οραματίστηκε το StaffNow για να λύσει το χρόνιο πρόβλημα εύρεσης προσωπικού.',
    initials: 'ΕΑ',
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-28 lg:px-8 lg:py-36">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl leading-[1.1]">
              Αλλάζουμε τον τρόπο{' '}
              <span className="text-blue-500">πρόσληψης</span>
            </h1>
            <p className="mt-6 text-lg text-gray-400 leading-relaxed">
              Το StaffNow γεννήθηκε από μια απλή ιδέα: η εύρεση προσωπικού δεν πρέπει
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div>
              ...
              <h2 className="mt-3 text-3xl font-bold text-gray-900 sm:text-4xl">
                Να συνδέσουμε κάθε επιχείρηση με τον ιδανικό εργαζόμενο
              </h2>
              <p className="mt-6 text-gray-600 leading-relaxed">
                Πολλοί κλάδοι στην Ελλάδα αντιμετωπίζουν κάθε χρόνο τεράστιο πρόβλημα στελέχωσης.
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-gray-600">
                      Να γίνουμε η #1 πλατφόρμα πρόσληψης στην Ελλάδα και τη Μεσόγειο.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
      ...
      <section className="bg-gray-50 py-20 sm:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-3 text-3xl font-bold text-gray-900 sm:text-4xl">
              Από μια ιδέα στην Θεσσαλονίκη, στην πλατφόρμα που αλλάζει την αγορά εργασίας
            </h2>
          </div>
          <div className="mx-auto mt-12 max-w-3xl space-y-6 text-gray-600 leading-relaxed">
            <p>
              Το καλοκαίρι του 2024, μια ομάδα ανθρώπων με εμπειρία στη στελέχωση και την τεχνολογία
              συναντήθηκε στη Θεσσαλονίκη με μία απλή παρατήρηση: η αναζήτηση προσωπικού γίνεται
              ακόμα μέσα από γενικές <strong>πλατφόρμες αγγελιών</strong> &mdash; εργαλεία που
              αντιμετωπίζουν κάθε επάγγελμα με τον ίδιο τρόπο, χωρίς να καταλαβαίνουν τις
              πραγματικές ανάγκες ούτε των επιχειρήσεων ούτε των εργαζομένων.
            </p>
            <p>
              Ο επιχειρηματίας ανεβάζει αγγελία και <strong>περιμένει στα τυφλά</strong>: δεν ξέρει
              ποιος θα την δει, πότε, ή αν ταιριάζει στις ανάγκες του. Δεκάδες άσχετα βιογραφικά
              καταλήγουν στο email του, και η αγγελία θάβεται μέσα σε χιλιάδες άλλες. Από την
              άλλη, ο εργαζόμενος <strong>στέλνει δέκα CVs και απαντούν τα δύο</strong> &mdash; αν
              απαντήσουν. Στο μεταξύ, μια θέση που χρειάζεται κάλυψη <em>τώρα</em>, καλύπτεται
              μετά από εβδομάδες. Ή ποτέ.
            </p>
            <p>
              Το <strong>StaffNow</strong> δημιουργήθηκε για να κλείσει αυτό το κενό. Αντί για
              στατικές αγγελίες και τυφλές αποστολές, εργαζόμενοι και επιχειρήσεις ανακαλύπτουν ο
              ένας τον άλλον με <strong>swipe-based matching</strong>: κάνεις &laquo;like&raquo; σε
              αυτούς που σε ενδιαφέρουν, και μόλις υπάρχει αμοιβαίο ενδιαφέρον, ξεκινάει το chat.
              Καμία αναμονή, καμία τυφλή αποστολή &mdash; μόνο πραγματικά ταιριάσματα, σε πραγματικό
              χρόνο, με τη βοήθεια AI που προτείνει υποψηφίους και αγγελίες βάσει του προφίλ.
            </p>
            <p>
              Σήμερα, λιγότερο από έναν χρόνο μετά το launch, επιχειρήσεις από όλους τους κλάδους
              και την Ελλάδα ολόκληρη εμπιστεύονται το StaffNow για τη στελέχωσή τους &mdash; από
              εστίαση και φιλοξενία μέχρι λιανικό εμπόριο, υπηρεσίες, logistics και χειρωνακτικά
              επαγγέλματα. Με <strong>πάνω από 10.000 εγγεγραμμένους εργαζόμενους</strong> και
              <strong> 1.000+ ενεργές επιχειρήσεις</strong>, συνεχίζουμε να βελτιώνουμε την
              πλατφόρμα κάθε μέρα &mdash; με έναν στόχο: η πρόσληψη να γίνεται τόσο γρήγορα όσο
              πραγματικά πρέπει.
            </p>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 mx-auto max-w-2xl text-gray-600">
              Μια μικρή αλλά δυναμική ομάδα με πάθος για την καινοτομία στην αγορά εργασίας.
            </p>
          </div>
          <div className="mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {team.map((member) => (
