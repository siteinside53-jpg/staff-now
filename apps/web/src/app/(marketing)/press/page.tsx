    ...
    <>
      <section className="bg-gray-950 text-white py-20 sm:py-28">
        <div className="mx-auto max-w-4xl px-4 text-center">
          <p className="text-sm font-semibold uppercase tracking-wider text-blue-400"><Tr k="press.hero.eyebrow" /></p>
          <h1 className="mt-4 text-4xl font-extrabold sm:text-5xl"><Tr k="press.hero.title" /></h1>
          <p className="mt-6 text-lg text-gray-400"><Tr k="press.hero.subtitle" /></p>
        </div>
      </section>
      ...
      {articles.length > 0 && (
        <section className="py-20 bg-white">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-8"><Tr k="press.articlesTitle" /></h2>
      ...
      <section className="py-20 bg-gray-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-2">
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-4"><Tr k="press.kit.title" /></h2>
              <p className="text-gray-600 mb-6"><Tr k="press.kit.description" /></p>
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-4"><Tr k="press.brandColors" /></h2>
      ...
      <section className="py-20 bg-white">
        <div className="mx-auto max-w-3xl px-4 text-center">
          <h2 className="text-2xl font-bold text-gray-900"><Tr k="press.contact.title" /></h2>
          <p className="mt-4 text-gray-600"><Tr k="press.contact.subtitle" /></p>
          ...
          <p className="mt-6 text-sm text-gray-400"><Tr k="press.contact.response" /></p>
        </div>
      </section>
    </>
  );
