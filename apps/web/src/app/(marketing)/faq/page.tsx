...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Για εργαζόμενους: Πάντα 100% δωρεάν. Για επιχειρήσεις: Free (0€) για δοκιμή, Starter (14,99€/μήνα) για μικρές επιχειρήσεις, Professional (29,99€/μήνα) για ομάδες που προσλαμβάνουν συνεχώς. Επιπλέον μπορείς να αγοράσεις πακέτα credits χωρίς μηνιαία συνδρομή. Όλα τα πλάνα ακυρώνονται οποιαδήποτε στιγμή, χωρίς ποινές.',
  },
  {
