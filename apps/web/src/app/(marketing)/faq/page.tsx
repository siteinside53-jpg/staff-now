...
const faqs = [
  {
    ...
    answer:
      'Το StaffNow είναι η πρώτη swipe-style πλατφόρμα matching στην Ελλάδα. Συνδέει επιχειρήσεις σε κάθε κλάδο (εστίαση, retail, logistics, υγεία, κατασκευές κ.ά.) με αξιόπιστους εργαζόμενους μέσω ενός γρήγορου και εύχρηστου συστήματος matching.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Για εργαζόμενους: δωρεάν χρήση, με προαιρετικό Premium 4,99€ εφάπαξ. Για επιχειρήσεις: Free (0€) για δοκιμή, Starter (29€/μήνα), Pro (79€/μήνα) για ομάδες που προσλαμβάνουν συνεχώς και Elite (149€/μήνα) για μεγαλύτερους οργανισμούς. Οι τιμές των επιχειρηματικών πλάνων είναι χωρίς ΦΠΑ (προστίθεται 24% στην πληρωμή). Με ετήσια χρέωση πληρώνεις 9 μήνες αντί για 12 (έκπτωση 25%). Επιπλέον μπορείς να αγοράσεις πακέτα credits χωρίς μηνιαία συνδρομή. Όλα τα πλάνα ακυρώνονται οποιαδήποτε στιγμή, χωρίς ποινές.',
  },
  {
