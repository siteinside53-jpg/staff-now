...
const PERK_KEYS = ['remoteFirst', 'stockOptions', 'unlimitedPto', 'learningBudget', 'teamRetreats', 'healthInsurance'] as const;

const PERK_ICONS: Record<(typeof PERK_KEYS)[number], React.ReactNode> = {
  remoteFirst: (
...
interface PositionDef {
  ...
  title: string;
  department: string;
  location: 'thessRemote' | 'thess' | 'remote' | 'nationwide';
  type: string;
}
...
export function CareersContent() {
  ...
  const locationLabel = (loc: PositionDef['location']) => {
    switch (loc) {
      case 'thessRemote':
        return t('careers.positions.locationThessRemote');
      case 'thess':
        return t('careers.positions.locationThess');
      case 'remote':
        return t('careers.positions.locationRemote');
      case 'nationwide':
        return t('careers.positions.locationNationwide');
    }
  };
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-gray-950 text-white">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-28 lg:px-8 lg:py-36">
          <div className="mx-auto max-w-3xl text-center">
            <p className="mb-4 text-sm font-semibold uppercase tracking-wider text-blue-400">{t('careers.hero.eyebrow')}</p>
            <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl leading-[1.1]">
              {t('careers.hero.titleLead')}{' '}
              <span className="text-blue-500">{t('careers.hero.titleHighlight')}</span>
            </h1>
            <p className="mt-6 text-lg text-gray-400 leading-relaxed">{t('careers.hero.subtitle')}</p>
            <div className="mt-10">
              <a
                href="#positions"
      ...
      <section className="bg-white py-20 sm:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <p className="text-sm font-semibold uppercase tracking-wider text-blue-600">{t('careers.why.eyebrow')}</p>
            <h2 className="mt-3 text-3xl font-bold text-gray-900 sm:text-4xl">{t('careers.why.title')}</h2>
            <p className="mt-4 mx-auto max-w-2xl text-gray-600">{t('careers.why.subtitle')}</p>
          </div>
          <div className="mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {PERK_KEYS.map((key) => (
              <div key={key} className="group rounded-2xl border border-gray-100 bg-white p-6 shadow-sm hover:shadow-md transition-all">
                ...
                <h3 className="mt-4 text-lg font-bold text-gray-900">{t(`careers.perks.${key}.title`)}</h3>
                <p className="mt-2 text-sm text-gray-600 leading-relaxed">{t(`careers.perks.${key}.description`)}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="bg-gray-50 py-20 sm:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div>
              <p className="text-sm font-semibold uppercase tracking-wider text-blue-600">{t('careers.culture.eyebrow')}</p>
              <h2 className="mt-3 text-3xl font-bold text-gray-900 sm:text-4xl">{t('careers.culture.title')}</h2>
              <div className="mt-6 space-y-4 text-gray-600 leading-relaxed">
                <p>{t('careers.culture.p1')}</p>
                <p>{t('careers.culture.p2')}</p>
                <p>{t('careers.culture.p3')}</p>
              </div>
            </div>
            <div className="space-y-4">
              <div className="rounded-2xl bg-white border border-gray-100 p-6 shadow-sm">
                <div className="flex items-center gap-3 text-blue-600 mb-3">
                  ...
                  <h3 className="font-bold text-gray-900">{t('careers.culture.moveFast.title')}</h3>
                </div>
                <p className="text-sm text-gray-600">{t('careers.culture.moveFast.description')}</p>
              </div>
              <div className="rounded-2xl bg-white border border-gray-100 p-6 shadow-sm">
                <div className="flex items-center gap-3 text-blue-600 mb-3">
                  <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                  ...
                  <h3 className="font-bold text-gray-900">{t('careers.culture.ownWork.title')}</h3>
                </div>
                <p className="text-sm text-gray-600" dangerouslySetInnerHTML={{ __html: t('careers.culture.ownWork.description') }} />
              </div>
              <div className="rounded-2xl bg-white border border-gray-100 p-6 shadow-sm">
                <div className="flex items-center gap-3 text-blue-600 mb-3">
                  <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                  ...
                  <h3 className="font-bold text-gray-900">{t('careers.culture.beTransparent.title')}</h3>
                </div>
                <p className="text-sm text-gray-600">{t('careers.culture.beTransparent.description')}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="positions" className="bg-white py-20 sm:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <p className="text-sm font-semibold uppercase tracking-wider text-blue-600">{t('careers.positions.eyebrow')}</p>
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                  <div className="flex-1">
                    ...
                    <p className="mt-1 text-sm text-gray-600 leading-relaxed">
                      {t(`careers.positions.list.${position.key}`)}
                    </p>
      ...
      <section className="bg-gray-950 py-20 sm:py-28">
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-white sm:text-4xl">{t('careers.openCta.title')}</h2>
          <p className="mt-4 text-lg text-gray-400">{t('careers.openCta.subtitle')}</p>
          <div className="mt-10">
            <Link
              href="mailto:careers@staffnow.gr?subject=Open Application"
              className="inline-flex items-center justify-center rounded-xl bg-blue-600 px-8 py-4 text-base font-semibold text-white shadow-lg shadow-blue-600/25 hover:bg-blue-700 transition-all"
            >
              {t('careers.openCta.cta')}
              <svg className="ml-2 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
