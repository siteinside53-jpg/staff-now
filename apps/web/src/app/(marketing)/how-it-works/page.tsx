      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center">
          <h1 className="text-4xl font-bold text-gray-900 sm:text-5xl">
            <Tr k="howItWorks.title" />
          </h1>
          <p className="mt-4 text-lg text-gray-600">
            <Tr k="howItWorks.subtitle" />
          </p>
        </div>
              ...
              <div className="flex-1 pb-8">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900">
                    <Tr k={`howItWorks.steps.${step.key}.title`} />
                  </h3>
                </div>
                <p className="mt-3 text-gray-600 leading-relaxed">
                  <Tr k={`howItWorks.steps.${step.key}.description`} />
                </p>
              </div>
            </div>
          ))}
        ...
        <div className="mt-16 text-center">
          <h2 className="text-2xl font-bold text-gray-900">
            <Tr k="howItWorks.cta.title" />
          </h2>
          <p className="mt-3 text-gray-600">
            <Tr k="howItWorks.cta.text" />
          </p>
          <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Button asChild size="lg">
              <Link href="/auth/register"><Tr k="howItWorks.cta.register" /></Link>
            </Button>
            <Button asChild size="lg" variant="outline">
              <Link href="/pricing"><Tr k="howItWorks.cta.plans" /></Link>
            </Button>
          </div>
        </div>
      </div>
