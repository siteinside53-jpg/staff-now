      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-3xl text-center">
          <h1 className="text-4xl font-bold text-gray-900 sm:text-5xl">
            <Tr k="forWorkers.title" />
          </h1>
          <p className="mt-4 text-lg text-gray-600">
            <Tr k="forWorkers.subtitle" />
          </p>
        </div>
            ...
            <Card key={feature.key} className="transition-shadow hover:shadow-md">
              <CardContent className="p-6">
                ...
                <h3 className="mt-4 text-lg font-semibold text-gray-900">
                  <Tr k={`forWorkers.features.${feature.key}.title`} />
                </h3>
                <p className="mt-2 text-sm text-gray-600 leading-relaxed">
                  <Tr k={`forWorkers.features.${feature.key}.description`} />
                </p>
              </CardContent>
            </Card>
          ))}
        ...
        <div className="mt-20 rounded-2xl bg-gray-950 p-8 text-center sm:p-12">
          <h2 className="text-3xl font-bold text-white">
            <Tr k="forWorkers.cta.title" />
          </h2>
          <p className="mt-4 text-lg text-gray-400">
            <Tr k="forWorkers.cta.text" />
          </p>
          <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
            ...
            <Link href="/how-it-works" className="inline-flex items-center justify-center rounded-xl border border-gray-600 px-8 py-3.5 text-base font-semibold text-gray-300 hover:text-white hover:border-gray-400 transition-colors">
              <Tr k="forWorkers.cta.howItWorks" />
            </Link>
          </div>
        </div>
      </div>
