    ...
    <div className="h-full flex flex-col bg-white overflow-y-auto">
      ...
      {items.length === 0 ? (
        <div className="flex-1 flex flex-col items-center justify-center px-8 text-center">
          ...
          <Link href="/app2/version3/swipe" className="mt-6 rounded-full bg-blue-600 px-6 py-2.5 text-sm font-bold text-white">
            🎯 Swipe τώρα
          </Link>
        </div>
      ) : (
        <>
          ...
          <div className="px-4 py-5 border-b border-gray-100">
            ...
            <div className="flex gap-3 overflow-x-auto -mx-4 px-4 pb-2">
              {items.slice(0, 8).map((m) => (
                <Link key={m.id} href="/app2/version3/chat" className="flex-shrink-0 text-center">
          ...
          <div className="flex-1 px-4 py-4">
            ...
            <div className="space-y-2">
              {items.map((m) => (
                <Link key={m.id} href="/app2/version3/chat" className="flex items-center gap-3 p-3 rounded-2xl hover:bg-gray-50 transition-colors">
