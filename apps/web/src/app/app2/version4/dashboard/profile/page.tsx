  ...
  return (
    <div className="h-full flex flex-col bg-gray-50 overflow-y-auto">
      ...
      <div className="flex-shrink-0 bg-gradient-to-br from-purple-600 via-pink-500 to-red-500 px-4 pt-8 pb-20 text-center text-white relative">
        <Link href="/app2/version4/dashboard/settings" className="absolute top-6 right-4 h-9 w-9 rounded-full bg-white/20 backdrop-blur flex items-center justify-center">
      ...
      <div className="px-4 mt-6 space-y-4 pb-6">
        ...
        <Link href="/app2/version4/dashboard/profile/edit" className="block rounded-2xl bg-white p-5 shadow-sm">
        ...
        <div className="rounded-2xl bg-white shadow-sm overflow-hidden">
          <MenuItem icon="✏️" label="Επεξεργασία Προφίλ" href="/app2/version4/dashboard/profile/edit" />
          <MenuItem icon="🔔" label="Ειδοποιήσεις" href="/app2/version4/dashboard/notifications" />
          <MenuItem icon="💎" label={isWorker ? 'Αναβάθμιση Πλάνου' : 'Credits & Αναβάθμιση'} href="/dashboard/billing" accent />
          <MenuItem icon="⚙️" label="Ρυθμίσεις" href="/app2/version4/dashboard/settings" />
