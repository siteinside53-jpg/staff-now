...
function HireCard({
  ...
  */
   ...
   *
   * Όταν δεν τρέχει τίποτα, το `busy` είναι null. Οι προσλήψεις που δηλώνονται
   * μέσα από συνομιλία, χωρίς συγκεκριμένη αγγελία, έχουν `job_id` επίσης null.
   * Άρα το `busy === hire.job_id` γινόταν `null === null` → αληθές, και ο
   * εργαζόμενος έβλεπε το «Ναι, ξεκίνησα» ξεθωριασμένο να μην πατιέται ποτέ.
   */
  const working = busy !== null && (busy === hire.id || busy === hire.job_id);
