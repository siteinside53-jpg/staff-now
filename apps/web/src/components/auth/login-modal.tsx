        ...
        <div className="rounded-3xl bg-white p-8 shadow-2xl">
          {view === 'main' && (
            <>
              ...
              {/*
                Οι εφαρμογές ΔΕΝ έχουν δημοσιευτεί ακόμη — ούτε σε Apple ούτε σε
                Google. Εδώ έγραφε «Διαθέσιμο στο App Store» και τα κουμπιά
                άλλαζαν χρώμα σαν να πατιούνται, χωρίς να οδηγούν πουθενά:
                υπόσχεση για κάτι που δεν υπάρχει. Τώρα λένε «Σύντομα», ίδια
                σήμανση με την αρχική σελίδα, και δεν μοιάζουν με κουμπιά.
              */}
