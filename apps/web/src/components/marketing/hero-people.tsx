 ...
 */
/**
 * ΓΙΑΤΙ 9 ΣΕΙΡΕΣ: το ταπέτο κυλάει, οπότε ΕΝΑ αντίγραφό του πρέπει να είναι
 * ψηλότερο από το hero — αλλιώς, στο μισό της διαδρομής, φαίνεται κενό.
 * Μετρημένο: σε οθόνη 1440 το hero είναι 776px και ένα αντίγραφο 1297px· στη
 * στενότερη οθόνη υπολογιστή (1024) το hero είναι 805px και το αντίγραφο
 * 923px. Και στις δύο καλύπτει. Με 5 σειρές υπολείπονταν.
 *
 * Συνέπεια για τις φωτογραφίες: 10 × 9 = 90 θέσεις. Τόσες χρειάζονται για να
 * μην επαναληφθεί καμία.
 */
const COLS = 10;
const ROWS = 9;
const COLS_MOBILE = 3;
