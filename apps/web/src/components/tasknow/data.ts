...
/**
 * Η κατηγορία με την οποία ανοίγει η φόρμα «Ανέβασε μικροδουλειά».
 *
 * Είχε σβηστεί κατά λάθος (23/08) ενώ η φόρμα την εισήγαγε ακόμη: η φόρμα
 * ξεκινούσε με κατηγορία `undefined` και ο server απαντούσε «Λείπουν στοιχεία»
 * σε όποιον δεν άλλαζε την κατηγορία με το χέρι. Ο φύλακας πλέον ελέγχει ότι
 * ό,τι εισάγεται από αυτό το αρχείο υπάρχει πράγματι.
 */
export const DEFAULT_CATEGORY = CATEGORIES[0]!.key;
